...
// CommitRandomness is a paid mutator transaction binding the contract method 0x8fb59e3b.
//
// Solidity: function commitRandomness(uint64 _questID, bytes _signature) returns()
func (_Raffle *RaffleTransactor) CommitRandomness(opts *bind.TransactOpts, _questID uint64, _signature []byte) (*types.Transaction, error) {
	return _Raffle.contract.Transact(opts, "commitRandomness", _questID, _signature)
}

// CommitRandomness is a paid mutator transaction binding the contract method 0x8fb59e3b.
//
// Solidity: function commitRandomness(uint64 _questID, bytes _signature) returns()
func (_Raffle *RaffleSession) CommitRandomness(_questID uint64, _signature []byte) (*types.Transaction, error) {
	return _Raffle.Contract.CommitRandomness(&_Raffle.TransactOpts, _questID, _signature)
}

// CommitRandomness is a paid mutator transaction binding the contract method 0x8fb59e3b.
//
// Solidity: function commitRandomness(uint64 _questID, bytes _signature) returns()
func (_Raffle *RaffleTransactorSession) CommitRandomness(_questID uint64, _signature []byte) (*types.Transaction, error) {
	return _Raffle.Contract.CommitRandomness(&_Raffle.TransactOpts, _questID, _signature)
}
